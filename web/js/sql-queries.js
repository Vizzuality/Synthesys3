var admin1ChoroplethQuery = _.template('WITH gadm28 as (select the_geom_webmercator FROM gadm28_adm1 WHERE iso= <%= country %>)\n' +
...
var genderCountryPieChartQuery = _.template('WITH gadm28 AS (SELECT the_geom_webmercator, iso2 FROM  gadm28_countries WHERE iso2 = <%= country %>)\n' +
...
var disciplineCountryBubbleChartQuery = _.template('WITH gadm28 AS (SELECT the_geom_webmercator, iso2 FROM  gadm28_countries WHERE iso2 = <%= country %>)\n' +
...
var researchersCountryBarChartQuery = _.template('WITH gadm28 AS (SELECT the_geom_webmercator, iso2 FROM  gadm28_countries WHERE iso2 = <%= country %>)\n' +
...
var researcherCountryDonutChartQuery = _.template('WITH gadm28 AS (SELECT the_geom_webmercator, iso2 FROM  gadm28_countries WHERE iso2 = <%= country %>)\n' +
...
var institutesVisitedCountryTreeChartQuery = _.template('WITH gadm28 AS (SELECT the_geom_webmercator, iso2 FROM  gadm28_countries WHERE iso2 = <%= country %>)\n' +
...
var dynamicSentenceCountryQuery = _.template('WITH gadm28 AS (SELECT the_geom_webmercator, iso2 FROM  gadm28_countries WHERE iso2 = <%= country %>)\n' +
